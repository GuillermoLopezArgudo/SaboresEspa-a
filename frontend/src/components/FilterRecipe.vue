  ...
  <div class="w-full bg-white rounded-xl shadow-sm border border-amber-200 p-4">
    <div class="flex flex-wrap gap-4">
      ...
      <div class="relative">
        ...
        <div
          class="absolute z-10 mt-1 w-56 bg-white rounded-md shadow-lg border border-amber-200 transition-all duration-200 origin-top"
          ...
          <div class="p-2 space-y-1">
            <label v-for="type in foodTypes" :key="type.value"
              class="flex items-center px-3 py-2 hover:bg-amber-50 rounded cursor-pointer">
      ...
      <div class="relative">
        ...
        <div
          class="absolute z-10 mt-1 w-56 bg-white rounded-md shadow-lg border border-amber-200 max-h-96 overflow-y-auto transition-all duration-200 origin-top"
      ...
      <div class="flex items-center gap-2 ml-auto">
        ...
        <button @click="buscarFiltros"
          class="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg flex items-center transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
