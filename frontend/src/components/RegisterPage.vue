<template>
  <div
    class="min-h-screen bg-gradient-to-br from-amber-50 to-amber-100 dark:from-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
    <div class="w-full max-w-md bg-white/80 rounded-xl shadow-2xl overflow-hidden dark:bg-gray-800">
      <!-- Encabezado -->
      <div
        class="bg-gradient-to-r from-amber-600 to-amber-700 py-6 px-8 text-center dark:from-gray-700 dark:to-gray-800">
      ...
      <form @submit.prevent="OnSubmit" class="p-8">
        <!-- Mensaje de error -->
        <div v-if="error"
          class="mb-6 p-3 bg-red-50 border-l-4 border-red-500 text-red-700 rounded-r-lg flex items-center dark:bg-red-900 dark:border-red-700 dark:text-red-300">
        ...
        <div class="mb-5">
          ...
          <div class="relative">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-amber-500 absolute right-3 top-3.5" fill="none"
        ...
        <!-- Correo electrónico -->
        <div class="mb-5">
          <label for="email" class="block text-sm font-medium text-amber-700 mb-1 dark:text-amber-300">Correo
            electrónico</label>
          <div class="relative">
        ...
        <div class="mb-5">
          <label for="password"
            class="block text-sm font-medium text-amber-700 mb-1 dark:text-amber-300">Contraseña</label>
          <div class="relative">
        ...
        <div class="mb-5">
          <label for="confirmPassword"
            class="block text-sm font-medium text-amber-700 mb-1 dark:text-amber-300">Confirmar contraseña</label>
          <div class="relative">
        ...
        <!-- Botón de registro -->
        <button type="submit"
          class="w-full py-3 bg-gradient-to-r from-amber-600 to-amber-700 text-white font-bold rounded-lg shadow-lg hover:from-amber-700 hover:to-amber-800  flex items-center justify-center">
        ...
        <div class="mt-6 text-center">
          <router-link to="/login"
            class="text-amber-600 hover:text-amber-800 font-medium  inline-flex items-center dark:text-amber-300">
            ¿Ya tienes cuenta?
...
function OnSubmit() {
  ...
  axios.post(`${process.env.VUE_APP_API_URL}/register`, payload)
    ...
    .catch(err => {
      error.value = err.response?.data?.message || "Error en el servidor. Intente más tarde.";
      setTimeout(() => { error.value = ''; }, 3000);
    });
}
...
/* Efecto para el hover del botón */
button:hover {
