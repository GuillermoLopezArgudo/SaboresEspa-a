<template>
    ...
    <div class="bg-white/80 dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden w-full max-w-xs sm:max-w-md">
        ...
        <div class="bg-gradient-to-r from-amber-600 to-amber-800 p-3 sm:p-4">
            <h3 class="text-lg sm:text-xl font-bold text-white font-serif" v-if="commentId == null">Reportar Receta</h3>
...
const props = defineProps(['idrecipe', 'commentId']);
...
console.log(recipeId.value, commentId.value)
</script>
