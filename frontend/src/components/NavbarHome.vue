<template>
      ...
      <nav class="bg-white shadow-md sticky top-0 z-10">
          ...
          <div class="flex justify-between items-center h-16">
            ...
            <div class="flex lg:hidden">
              <button @click="toggleNavbar"
                class="inline-flex items-center justify-center p-2 rounded-md text-amber-600 hover:text-amber-800 focus:outline-none">
            ...
            <div class="hidden lg:flex lg:items-center lg:space-x-8">
              ...
              <router-link to="/recipes_personal"
                class="px-3 py-2 text-sm font-medium text-amber-700 hover:text-amber-900 transition duration-300 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
              ...
              <button @click="logout"
                class="px-3 py-2 text-sm font-medium text-red-600 hover:text-red-800 transition duration-300 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div v-show="navbarOpen" class="lg:hidden bg-white shadow-lg">
          <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <router-link to="/create-recipes"
              class="block px-3 py-2 rounded-md text-base font-medium text-amber-700 hover:text-amber-900 hover:bg-amber-50 transition duration-300 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
            ...
            <button @click="logout"
              class="w-full text-left block px-3 py-2 rounded-md text-base font-medium text-red-600 hover:text-red-800 hover:bg-red-50 transition duration-300 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
  ...
  .router-link-exact-active {
    @apply text-amber-900 font-semibold border-b-2 border-amber-600;
  }
  ...
  .router-link-active:first-child:hover svg {
